...
export default function CompensadoPlastificadoPage() {
  return (
    <ProductIntentPage
      ...
      subtitle="Atendimento para quem busca compensado plastificado para obras e outras aplicações, com orçamento direto pelo WhatsApp e suporte comercial ágil."
      introTitle="Sobre o compensado plastificado"
      introText="O compensado plastificado é uma linha procurada por quem busca resistência, durabilidade e melhor acabamento, conforme a aplicação. Na Madeiras Santos, o atendimento é direcionado para quem precisa de orçamento mais rápido e orientação comercial na escolha do material."
