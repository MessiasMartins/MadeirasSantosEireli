...
export default function OsbPage() {
  return (
    <ProductIntentPage
      ...
      introText="O OSB é uma linha bastante buscada para fechamentos, divisórias, tapumes e outras aplicações em obra. A Madeiras Santos atende Belo Horizonte e região metropolitana com foco em orçamento rápido e orientação comercial."
