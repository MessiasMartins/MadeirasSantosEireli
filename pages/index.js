          ...
          <main className="relative z-10 px-4 pt-4 pb-8">
            ...
            <div className="mt-6 space-y-3">
              ...
              <a
                ...
                className="w-full min-h-[48px] flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-800 bg-yellow-50 border-yellow-200 hover:bg-yellow-100"
              >
                E-Mail
              </a>
              <a
