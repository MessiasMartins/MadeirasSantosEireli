  ...
  return (
    <>
      <PageSEO
        ...
        description="Compensado plastificado, compensado resinado, OSB, madeira para telhado, portas e itens complementares em Belo Horizonte e região metropolitana. Solicite orçamento pelo WhatsApp."
      />
      <Head>
        <script
      ...
      <section className="rounded-2xl bg-emerald-50 p-6 dark:bg-gray-800/70">
        ...
        <p className="mt-4 text-sm text-gray-700 dark:text-gray-300">
          Compensados, OSB, madeira para telhado, portas e itens complementares • Atendimento de
          segunda a sexta, das 8h às 17h30, e sábado, das 8h às 12h
        </p>
      </section>
      ...
      <section className="divide-y divide-gray-200 pt-10 dark:divide-gray-700">
        <div className="space-y-3">
          ...
          <p className="text-base leading-7 text-gray-600 dark:text-gray-300 sm:text-lg">
            Também trabalhamos com outros itens para atender diferentes necessidades de obra,
            estrutura e acabamento, conforme disponibilidade.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-4 pt-6 md:grid-cols-2 lg:grid-cols-3">
