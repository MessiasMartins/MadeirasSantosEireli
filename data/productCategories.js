const productCategories = [
  {
    id: 'chapas-e-compensados',
    slug: 'chapas-e-compensados',
    name: 'Chapas e Compensados',
  ...
  },
  {
    ...
    imageAlt: 'Telhas para obras e coberturas disponíveis na Madeiras Santos',
    applications: ['coberturas residenciais', 'reformas de telhado', 'obra nova', 'reposição'],
    featuredProductSlug: 'telha-portuguesa',
  },
  {
    id: 'portas-e-marcos',
    slug: 'portas-e-marcos',
    name: 'Portas, Marcos e Ferragens',
    title: 'Portas, Marcos e Ferragens',
    href: '/produtos/portas-e-marcos',
    description:
      'Portas de madeira, marcos, dobradiças, fechaduras e itens de apoio para instalação e acabamento.',
    seoDescription:
      'Portas de madeira, marcos, dobradiças, fechaduras e itens de apoio para instalação e acabamento. Ideal para quem busca praticidade na compra e atendimento direto em um só lugar.',
    ctaLabel: 'Consultar portas e marcos',
    imageAlt: 'Portas, marcos e ferragens disponíveis na Madeiras Santos',
    applications: ['portas internas', 'portas externas', 'instalação', 'acabamento'],
    featuredProductSlug: 'porta-interna',
  },
  {
    id: 'servicos-e-sob-encomenda',
    slug: 'servicos-e-sob-encomenda',
    name: 'Serviços e Sob Encomenda',
